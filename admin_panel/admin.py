...
class ProductModerationAdmin(admin.ModelAdmin):
    list_display = ('product', 'status', 'moderator', 'created_at', 'approved_at')
    ...
    def approve_selected(self, request, queryset):
        ...
        self.message_user(request, f"{updated} produits approuvés.")
    ...
    def reject_selected(self, request, queryset):
        ...
        self.message_user(request, f"{updated} produits rejetés.")
...
class ReportAdmin(admin.ModelAdmin):
    ...
    list_filter = ('status', 'created_at')
    raw_id_fields = ('reporter', 'user', 'product')

    def content_object(self, obj):
        return obj.product or obj.user
