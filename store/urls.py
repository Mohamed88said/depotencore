...
urlpatterns = [
    ...
    path('location/my-locations/', views.my_locations, name='my_locations'),
    path('location/search/', views.search_addresses, name='search_addresses'),
    path('location/api/prefectures/', views.get_prefectures, name='get_prefectures'),
    path('location/api/quartiers/', views.get_quartiers, name='get_quartiers'),
    path('location/api/reverse-geocode/', views.reverse_geocode, name='reverse_geocode'),
    path('location/addresses/', views.address_list, name='address_list'),
    path('location/addresses/<int:address_id>/', views.address_detail, name='address_detail'),
    path('location/contribute/', views.contribute_address, name='contribute_address'),
]